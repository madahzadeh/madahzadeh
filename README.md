...
**Mobile Product Architect · AI Automation Architect · Web Architecture · Technical SEO**

I design and build practical digital products for founders and international businesses—from native and cross-platform mobile apps to backend integrations, AI-enabled workflows, multilingual platforms, and performance-focused web systems.

## Core capabilities

- **Mobile products:** Flutter, Swift, SwiftUI, React Native/Expo, iOS, and Android
- **AI automation:** LLM integrations, workflow automation, approval systems, and human-in-the-loop operations
- **Backend & APIs:** Supabase, REST APIs, WordPress integrations, and Cloudflare services
...
| **[llms-txt-audit](https://github.com/madahzadeh/llms-txt-audit)** [![npm](https://img.shields.io/npm/v/llms-txt-audit)](https://www.npmjs.com/package/llms-txt-audit) | Generates and validates `llms.txt` files (llmstxt.org) from a site crawl or XML sitemap | `npx llms-txt-audit validate <url>/llms.txt` |
